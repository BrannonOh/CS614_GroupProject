...
def build_judging_user_prompt(
    ...
    raw_text: str,
    content_blueprint_json: str,
    final_speech: str,
) -> str:
    return f"""
Evaluate the following final speech based on the planner blueprint, content blueprint, and the intended speaker's style.

Planner blueprint (for task, audience, purpose, and constraints):
{planner_blueprint_json}

Content blueprint (for final intended content, grounded facts, and narrative structure):
...
- Use the content blueprint to evaluate:
  - Narrative Coherence
